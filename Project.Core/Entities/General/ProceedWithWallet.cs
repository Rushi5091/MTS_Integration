...
{
    public class ProceedWithWallet
    {
        ...
        [Range(1, 9999999999, ErrorMessage = "FromCurrency_Code must be in charactor.")]
        public string? FromCurrency_Code { get; set; }

        [Required(ErrorMessage = "Please Enter ToCurrency_Code")]
        [Range(1, 9999999999, ErrorMessage = "ToCurrency_Code must be in charactor.")]
