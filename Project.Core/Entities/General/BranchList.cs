...
namespace Project.Core.Entities.General
{
    public class BranchList
    {
        ...
        [Required(ErrorMessage = "Please Enter PaymentDepositeType ID.")]
        [Range(1, 9999999999, ErrorMessage = "PaymentDepositeType ID must be between 1 and 10 digits.")]
        public int? PaymentDepositeTypeID { get; set; }
        ...
        [Range(1, 9999999999, ErrorMessage = "Country ID must be between 1 and 10 digits.")]
